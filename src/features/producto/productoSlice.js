  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAProduct.fulfilled, (state, action) => {
        ...
        state.isError = false;
        state.isSuccess = true;
        state.productVisible = action.payload.visible;
        ...
        state.discountPrice = action.payload.descuento;
        state.priceDiscount = action.payload.precioConDescuento;
        state.ribbonPrice = action.payload.cinta;
        state.productCategory = action.payload.categoria;
        state.productVariations = action.payload.variaciones; 
        state.productReference = action.payload.referencia;
        state.gender = action.payload.genero;
        state.sizeType = action.payload.tipoTela;
      })
