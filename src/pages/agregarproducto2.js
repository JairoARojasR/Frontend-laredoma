...
import { createProducts, resetState } from "../features/producto/productoSlice";
...
const Agregarproducto2 = () => {
  ...
  const brandState = useSelector((state) => state.marcaauto.marcas);
  const catState = useSelector((state) => state.categoria.categorias);
  const colorState = useSelector((state) => state.marcaauto.marcas);
...
export default Agregarproducto2;